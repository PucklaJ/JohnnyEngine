...
namespace Johnny
{
	...
	{
        return Matrix4f::lookAt(m_transform.getTranslation(),m_transform.getTranslation() + m_lookDirection,m_up);
    }
	...
	void Camera3D::setRotation(GLfloat x, GLfloat y, GLfloat z)
	{
        ...
        m_lookDirection = Matrix4f::rotate(y,Vector3f(0.0f,1.0f,0.0f)) * Matrix4f::rotate(x,Vector3f(1.0f,0.0f,0.0f)) * Vector4f(0.0f,0.0f,-1.0f,1.0f);
        
        m_up = Matrix4f::rotate(z,Vector3f(0.0f,0.0f,-1.0f)) * Vector4f(0.0f,1.0f,0.0f,1.0f);
    }
