...
void FrameBuffer::addTexture(Texture *t, GLuint attachment, GLenum target,
...
void FrameBuffer::addRenderBuffer(RenderBuffer *r, GLuint attachment,
                                  GLenum target) {
  bind(target);
  r->bind();
...
void FrameBuffer::bind(GLenum target) { glBindFramebuffer(target, m_fbo); }

void FrameBuffer::unbind(GLenum target) { glBindFramebuffer(target, 0); }

void FrameBuffer::blit(FrameBuffer *f, GLint sx0, GLint sy0, GLint sx1,
                       GLint sy1, GLint dx0, GLint dy0, GLint dx1, GLint dy1,
