...
void Timer::startTimeMeasure() { m_startTime = high_resolution_clock::now(); }
...
int Timer::endTimeMeasure() {
  ...
  m_realDeltaTimes[m_realDeltaTimeSize == 11 ? 10 : m_realDeltaTimeSize] =
      m_realDeltaTimeInSeconds;
