...
Keys InputManager::convertSDL(unsigned int sdl) {
  ...
  case SDLK_QUOTE:
    return Keys::QUOTE;
  case SDLK_LEFTPAREN:
    return Keys::LEFTPAREN;
  case SDLK_RIGHTPAREN:
    return Keys::RIGHTPAREN;
  case SDLK_ASTERISK:
  ...
  case SDLK_KP_LEFTPAREN:
    return Keys::KP_LEFTPAREN;
  case SDLK_KP_RIGHTPAREN:
    return Keys::KP_RIGHTPAREN;
  case SDLK_KP_LEFTBRACE:
    return Keys::KP_LEFTBRACE;
  case SDLK_KP_RIGHTBRACE:
    return Keys::KP_RIGHTBRACE;
  case SDLK_KP_TAB:
    return Keys::KP_TAB;
  ...
  case SDLK_KP_MEMSTORE:
    return Keys::KP_MEMSTORE;
  case SDLK_KP_MEMRECALL:
    return Keys::KP_MEMRECALL;
  case SDLK_KP_MEMCLEAR:
    return Keys::KP_MEMCLEAR;
  case SDLK_KP_MEMADD:
    return Keys::KP_MEMADD;
  case SDLK_KP_MEMSUBTRACT:
    return Keys::KP_MEMSUBTRACT;
  case SDLK_KP_MEMMULTIPLY:
    return Keys::KP_MEMMULTIPLY;
  case SDLK_KP_MEMDIVIDE:
    return Keys::KP_MEMDIVIDE;
  case SDLK_KP_PLUSMINUS:
    return Keys::KP_PLUSMINUS;
  case SDLK_KP_CLEAR:
    return Keys::KP_CLEAR;
  case SDLK_KP_CLEARENTRY:
    return Keys::KP_CLEARENTRY;
  case SDLK_KP_BINARY:
  ...
  case SDL_BUTTON_RIGHT:
    return Keys::MS_RIGHT;
  case SDL_BUTTON_MIDDLE:
    return Keys::MS_MIDDLE;
  case SDL_BUTTON_X1:
    return Keys::MS_X1;
  case SDL_BUTTON_X2:
    return Keys::MS_X2;
...
InputManager::InputManager() { m_castsShadows3D = false; }
...
void InputManager::releaseKey(Keys kc) { m_keyMap[kc] = false; }

void InputManager::pressKey(Keys kc) { m_keyMap[kc] = true; }
