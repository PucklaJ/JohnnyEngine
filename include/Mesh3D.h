...
namespace Johnny
{
	...
	/*! \brief A class which represents a bunch of vertices with a material on the graphics card
	 *
	 */
	class Mesh3D
	{
	public:
		 ...
		 *  \param switchZandY Defines if it should switch the z and y-Axises of the vertex positions
		 */
		 ...
		 */
		void addVertices(Vertex3D* v, unsigned int vsize, GLuint* indices, unsigned int isize);
