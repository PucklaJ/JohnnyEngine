...
public:
   ...
   *  \param withTime Defines wether the date and time should be included in the
   * log \param newLine Defines wether there should be a new line placed after
   * the log
   */
  static void log(const std::string &text, bool withTime = true,
                  bool newLine = true);
   ...
   *  \param withTime Defines wether the date and time should be included in the
   * log \param newLine Defines wether there should be a new line placed after
   * the log \param messageBox Defines wether there should be a MessageBox
   * opened with the error contents
   */
  static void error(const std::string &text, bool withTime = true,
                    bool newLine = true, bool messageBox = true);
...
private:
  ...
  static const char *m_file; //!< The relative or absolute path of the file
                             //!< where the logs go to
