...
namespace Johnny
{
    ...
    public:
        ...
        /*! \return If the PhysicsSprite2D should be destroyed if it moves out of the physics world
         *
         */
        bool getAutomaticDestroy() {return m_automaticDestroy;}
        /*! \return The offset that applies to the attaching of the Sprite2D to the b2Body 
         *
         */
        ...
        /*! \brief Sets if the PhysicsSprite2D should be destroyed if it moves out of the physics world
         *  \param b The bool value to set m_automaticDestroy
         */
        void setAutomaticDestroy(bool b) {m_automaticDestroy = b;}
        /*! \brief Sets the offset which applies to the attaching of the Sprite2D to the b2Body
         *  \param v The offset to set
         */
        void setOffset(const Vector2f& v) {m_offset = v;}

        /*! \brief Gets called when the b2Body of the PhysicsSprite2D begins colliding with another b2Body
    ...
    protected:
        ...
        Vector2f m_offset;              //!< The offset of the PhysicsSprite2D with which it gets attached to the b2Body in pixel coordinates
