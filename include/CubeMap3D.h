...
public:
   ...
   */
  CubeMap3D(const std::string &top, const std::string &bottom,
   ...
   */
  CubeMap3D(TextureData *top, TextureData *bottom, TextureData *left,
            TextureData *right, TextureData *front, TextureData *back);
};
} // namespace Johnny
