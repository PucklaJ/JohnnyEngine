...
public:
   ...
   */
  void addTexture(Texture *tex, GLuint attachment = GL_COLOR_ATTACHMENT0,
   ...
   * \param sx0 The x coordinate of the rectangle from which to take from this
   * frame buffer \param sy0 The y coordinate of the rectangle from which to
   * take from this frame buffer \param sx1 The width of the rectangle from
   * which to take from this frame buffer \param sy1 The height of the rectangle
   * from which to take from this frame buffer \param dx0 The x coordinate of
   * the rectangle on which to blit on the other frame buffer \param dy0 The y
   * coordinate of the rectangle on which to blit on the other frame buffer
   * \param dx1 The width of the rectangle on which to blit on the other frame
   * bufferr \param dy1 The height of the rectangle on which to blit on the
   * other frame buffer \param mask Which mask to blit \param filter Defines how
   * the pixels should be filtered
   */
  void blit(FrameBuffer *f, GLint sx0, GLint sy0, GLint sx1, GLint sy1,
            GLint dx0, GLint dy0, GLint dx1, GLint dy1,
            GLbitfield mask = GL_COLOR_BUFFER_BIT, GLenum filter = GL_LINEAR);
