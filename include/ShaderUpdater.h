...
public:
  static const unsigned int
      TRANSFORM_NORMAL; //!< The index to indicate that a normal transform
                        //!< should be loaded
  static const unsigned int
      TRANSFORM_CAMERA; //!< The index to indicate that a camera transformed
                        //!< transform should be loaded
  static const unsigned int
      TRANSFORM_WORLD; //!< The index to indicate that a world transform should
                       //!< be loaded;
   ...
   *  \param index The index of the function to make it possible to use multiple
   ...
   * versions of the function
   */
  virtual void setUniforms(Transform3D *transform,
   ...
   * versions of the function
   */
  virtual void setUniforms(Transform2D *transform,
                           const unsigned int index = 0) {}
   ...
   * versions of the function
   */
  virtual void setUniforms(TextureRegion *region,
                           const unsigned int index = 0) {}
