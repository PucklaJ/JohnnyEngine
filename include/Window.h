...
namespace Johnny
{
    ...
    {
        public:
			Window(MainClass*,const char* title = "Window Title",int x = SDL_WINDOWPOS_CENTERED,int y = SDL_WINDOWPOS_CENTERED,int w = NORM_W,int h = NORM_H,Uint32 flags = SDL_WINDOW_SHOWN);
            virtual ~Window();
