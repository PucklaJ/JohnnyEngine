...
public:
  ...
  Window *createWindow(const std::string &title, unsigned int x, unsigned int y,
  ...
  bool setWindowFullscreen(Window *window, bool fullscreen = true,
                           bool desktop = true) override;
  bool setWindowBorderless(Window *window, bool borderless = true) override;
  bool setWindowIcon(Window *window, Texture *tex,
                     GLenum target = GL_TEXTURE_2D, GLenum format = GL_RGBA,
                     GLenum type = GL_UNSIGNED_BYTE) override;
