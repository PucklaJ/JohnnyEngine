...
namespace Johnny
{
	...
	/*! \brief A index which stores a vertex position index, vertex normal index and a uvIndex DEPRECATED
	 *
	 */
	...
	/*! \brief A class which represents a bunch of textures a few colors and a few numbers to define how a mesh looks
	 *
	 */
	class Material
	{
	public:
         ...
         *  \param withTextures Defines wether the texture uniform sampler locations should be included
         */
	...
	private:
		 ...
		 */
		bool findInMap(std::map<std::tuple<GLuint, GLuint, GLuint>, GLuint>& Map, const std::tuple<GLuint, GLuint, GLuint>& value);
