...
public:
  ...
  int xrel; //!< The x coordinate of the relative vector from the last frame to
            //!< this
  int yrel; //!< The y coordinate of the relative vector from the last frame to
            //!< this
  signed int wheel_x; //!< The amount which the mousewheel was moved on the
                      //!< x-Axis in the last frame
  signed int wheel_y; //!< The amount which the mousewheel was moved on the
                      //!< y-Axis in the last frame
...
public:
  /*!\brief Converts the SDL keycode to Johnny::Keys
  ...
  /*! \brief Sets the amount of how much the mouse moved relative to the last
   * frame \param x The x amount \param y The y amount
   */
...
private:
  std::map<Keys, bool> m_keyMap; //!< The map which stores the statuses of the
                                 //!< keys from this frame
  std::map<Keys, bool>
      m_previousKeyMap; //!< The map which stores the statuses of the keys from
                        //!< the previouse frame
