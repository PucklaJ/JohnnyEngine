...
namespace Johnny
{
	...
	public:
		 ...
		 *  \return the value of the setting or false if the setting doesn't is a bool or doesn't exist
		 */
		static bool getb(SettingName s);
		/*! \brief Gets a setting width type of integer
		 *  \param s The name of the setting to get the value from
		 *  \return The value of the setting or 0 if the setting isn't a integer or the setting doesn't exist
		 */
