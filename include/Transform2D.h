...
namespace Johnny
{
	...
	public:
		 ...
		 */
		Transform2D(const Vector2f& translation, const GLfloat& rotation, const Vector2f& scale);
		~Transform2D();
	...
	{
	public:
		/*! \return The center of the coordinate system relative the center of the screen (will be multiplied onto the viewport size)
		 *
		 */
		 ...
		 *  \param center The center to set relative to the center of the screen (will be multiplied to onto the viewport size, internal use only)
		 */
		 ...
		 *  \param viewport The viewport which will be used for the calculation (if x=-1.0f && y-1.0f the viewport of the class will be used)
		 */
		static Vector2f toCoords(const Vector2f& v, const Vector2f& viewport = Vector2f(-1.0f,-1.0f));
		/*! \brief Converts a vector into the coordinate system
		 *  \param v The vector to convert
	...
	protected:
		...
		bool m_affectedByCenter = true; //!< Defines wether the object is centered not in the center of the screen
	private:
		static Vector2f center;							    //!< The center of the coordinate system (relative to the center of the screen)
		static Vector2f viewportSize;						//!< The size of the viewport
		static bool yAxisFlipped;							//!< Defines wether the y-Axis is flipped in the coordinate system
		static bool xAxisFlipped;							//!< Defines wether the x-Axis is flipped in the coordinate system
		static std::vector<TransformableObject2D*> objects; //!< An array with all TransformableObject2Ds
	};
}